...
from backend.api.app.core.database import get_db
from backend.api.app.models.log import FirewallLog, FirewallSuspiciousIP, FirewallTopPort
from backend.api.app.schemas.log import Log, SuspiciousIPOut, TopPortOut
